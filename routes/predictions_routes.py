...
@predictions_router.post("/", status_code=status.HTTP_201_CREATED, response_model=Prediction, response_class=JSONResponse)
...
@predictions_router.get("/", status_code=status.HTTP_200_OK, response_model=List[Prediction], response_class=JSONResponse)
def get_predictions(
    request: Request,
...
@predictions_router.get("/{prediction_id}", status_code=status.HTTP_200_OK, response_model=Prediction, response_class=JSONResponse)
...
@predictions_router.put("/{prediction_id}", status_code=status.HTTP_200_OK, response_model=Prediction, response_class=JSONResponse)
...
@predictions_router.delete("/deleteall", status_code=status.HTTP_200_OK, response_class=JSONResponse)
...
@predictions_router.delete("/{prediction_id}", status_code=status.HTTP_200_OK, response_model=dict, response_class=JSONResponse)
